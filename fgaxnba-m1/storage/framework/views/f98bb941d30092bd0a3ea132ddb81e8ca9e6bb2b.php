            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="login" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Почтовый адрес')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/astdvyrn/fgaxnba-m1/resources/views/auth/login.blade.php ENDPATH**/ ?>